...
String email = customerdto2.getEmail();
CustomerDao2 dao = CustomerDao2.getInstance();
CustomerDto2 dto = dao.select(email);
%>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="text-right" style="margin-bottom: 20px;">
				<a href="" id="saveCustomer" class="btn btn-outline-primary">회원수정</a>
	...
	$(function() {
		...
		cpwd.keyup(function(e) {
			...
			if (cpwd.val().length >= 8 && cpwd.val().length <= 12) {
				...
				cpwd.removeClass("is-valid");
				$("#errocrPwd").text('비밀번호는 8-12자리 이어야 합니다.');
				cpwd.addClass("is-invalid");
			}
