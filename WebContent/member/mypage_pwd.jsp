	...
	<div class="row">
		<div class="col-md-12">
			...
			<form method="post" name="f" action="checkPwd.jsp">
				<div class="form-group">
					<input type="text" class="form-control" id="email"
						name="email" placeholder="Your Email *" value="<%=email %>" readonly />
			...
			<div class="text-right" style="margin-bottom: 20px;">
				<a href="" id="checkPwd" class="btn btn-outline-primary">확인</a>
...
<script>
	$(function() {
		...
		/* // 엔터키를 누를 때/ 어떤 버튼을 눌렀는지 확인하는 용도
		email.keydown(function() {
			console.log('keydown : '+ email.val());
		}); */
		// 값을 가지고 조작을 할 때
