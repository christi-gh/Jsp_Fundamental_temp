			...
			<form method="post" name="f" action="">
				<div class="form-group">
					<label for="writer">작성자</label> <input type="text"
						...
						value="<%=writer%>" placeholder="작성자를 입력해주세요">
				</div>
				<div class="form-group">
				...
				<input type="hidden" name="num" value="<%=num%>" /> <input
					type="hidden" name="page" value="<%=cPage%>" />
			</form>
			<div class="text-right" style="margin-bottom: 20px;">
				<a href="" id="updateNotice" class="btn btn-outline-success">수정</a>
				<a href="" id="deleteNotice" class="btn btn-outline-danger">삭제</a> <a
					href="list.jsp?page=<%=cPage%>" class="btn btn-outline-primary">목록</a>
			</div>
		</div>
	</div>
</div>
